...
# Connect softcut.
jack_connect orn8:capture_1 softcut:input_1
jack_connect orn8:capture_2 softcut:input_2

# Connect to crone (monitor).
jack_connect orn8:capture_1 crone:input_1
jack_connect orn8:capture_2 crone:input_2
