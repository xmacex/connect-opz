...
# Start alsa_in.
alsa_in -d hw:CARD=OPZ -j opz &

# Wait for alsa_in to come up.
sleep 1

# Connect softcut.
jack_connect opz:capture_1 softcut:input_1
jack_connect opz:capture_2 softcut:input_2

# Connect to crone (monitor).
jack_connect opz:capture_1 crone:input_1
jack_connect opz:capture_2 crone:input_2
