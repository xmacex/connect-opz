...
# Start alsa_in.
alsa_in -d hw:CARD=H1n -j h1n &

# Wait for alsa_in to come up.
sleep 1

# Connect softcut.
jack_connect h1n:capture_1 softcut:input_1
jack_connect h1n:capture_2 softcut:input_2

# Connect to crone (monitor).
jack_connect h1n:capture_1 crone:input_1
jack_connect h1n:capture_2 crone:input_2
